...
!function( $ ) {
 ...
 "use strict";
  ...
  template: '<div class="input-group"><input class="combobox-input-hidden" type="hidden" /><input class="form-control" type="text" autocomplete="off" /><span class="input-group-addon add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
